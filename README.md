# genpark-creator-affiliate-gmv-commission-ledger-skill
...
**genpark-creator-affiliate-gmv-commission-ledger-skill** is a deterministic, zero-dependency Python skill engineered for autonomous creator operations, influencer marketing automation, and multi-agent campaign workflows.

> **Executive Capability**: Creator affiliate GMV tracking & return-adjusted commission ledger (LTK)
...
result = client.calculate_affiliate_payouts()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-creator-affiliate-gmv-commission-ledger-skill": {
      "command": "python",
      "args": ["/path/to/genpark-creator-affiliate-gmv-commission-ledger-skill/mcp_server.py"]
    }
  }
}
```
